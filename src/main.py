...
if __name__ == '__main__':
    ...
    class RTSPFactory(GstRtspServer.RTSPMediaFactory):
        ...
        def do_create_element(self, url):
            pipeline = "v4l2src device=/dev/video8 ! videoconvert ! video/x-raw,format=I420,width=552,height=650 ! x264enc speed-preset=ultrafast tune=zerolatency ! rtph264pay name=pay0 pt=96"
